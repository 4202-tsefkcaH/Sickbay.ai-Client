		...
		<div className="min-h-[100vh] w-[100vw] bg-[#171717]">
			...
			<main className="py-10 ">
				<div className="m-10 p-10 bg-[#222222] rounded-2xl flex justify-between items-center">
					<div>
						<h1 className="text-3xl text-white font-semibold m-2">
							<span className="text-[#44B1FF]">Name:</span> Ratul Saha
						</h1>
						<h1 className="text-2xl text-white font-semibold m-2">
							<span className="text-[#44B1FF]">Email:</span>{' '}
					...
					<div className="flex justify-around items-center gap-10">
						...
						<Button
							onClick={logOut}
							className="bg-[#2AA7FF] text-white p-4 rounded-lg"
						>
							Log Out
						</Button>
					</div>
					...
					<Table>
						...
						<TableBody>
							...
							<TableRow className="hover:bg-[#2AA7FF] bg-[#171717]">
								...
								<TableCell className="text-white">Malaria</TableCell>
							...
							<TableRow className="hover:bg-[#2AA7FF] bg-[#171717]">
								<TableCell className=" text-white font-semibold">
									Apollo_Blood_Test.jpg
								</TableCell>
								<TableCell className="text-white">Low Haemoglobin</TableCell>
								<TableCell className="text-white">
									A balanced diet that includes iron-rich foods can help
									maintain healthy red blood cells and hemoglobin levels
								</TableCell>
							</TableRow>
						</TableBody>
					</Table>
